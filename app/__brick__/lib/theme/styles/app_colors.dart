...
class AppColors {
  ...
  static const Color textBlue = Color(0xFF101828);
  static const Color textMain = Color(0xFF101828);

  /// label/tertiary [light] — текст disabled-кнопки (#101828 @ 50%)
  static Color labelTertiaryLight = Color(0xff101828).withValues(alpha: 0.5);
  static const Color textGrey = Color(0xFFF2F4F7);
  static const Color textGrey2 = Color(0xFF101828);
  ...
  // Primary Colors
  // ====================
  static const Color primaryColor = Color(0xFF1B2440);
  static const int _primaryPrimaryValue = 0xFF1B2440;

  static const MaterialColor primary =
      MaterialColor(_primaryPrimaryValue, <int, Color>{
        50: Color(0xFFEFF2FA),
        100: Color(0xFFD3DBEE),
        200: Color(0xFFB7C3E2),
        300: Color(0xFF95A8D3),
        400: Color(0xFF738CC2),
        500: Color(_primaryPrimaryValue),
        600: Color(0xFF161E36),
        700: Color(0xFF11182B),
        800: Color(0xFF0C121F),
        900: Color(0xFF070B14),
      });
  ...
  /// Figma `brand-gradient` — фон главного экрана.
  static const LinearGradient brandGradient = LinearGradient(
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
    colors: [Color(0xFF000E1E), Color(0xFF283646), Color(0xFF5A6878)],
  );
